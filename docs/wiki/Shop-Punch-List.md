...
| 11 | Room signs: universal pictogram + word signage per panel/window (AAC picture-board principle, ISO 7001 pictograms, recognition-over-recall; extends the shipped traffic-light design language; one shared header seam, enrolled in legibility scaling + WCAG gate) | owner's 2026-07-29 intake; board `Claude AI\Portfolio\boards\2026-07-29_RoomSigns.md` | BACKLOG — scope-first + blueprint before any code; shop is in wrap-up posture |
